...
// Get the offset position of the hp_navbar
var sticky = navbar.offsetTop;

// Add the sticky class to the hp_navbar when you reach its scroll position. Remove "sticky" when you leave the scroll position
...
var dropDownMenu = document.querySelectorAll('ul.navbar-nav li.dropdown');
for (var i = 0; i < dropDownMenu.length; i++) {
    dropDownMenu[i].addEventListener("mouseenter", function() {
...
var dropDownMenuLinks = document.querySelectorAll('ul.navbar-nav li.dropdown a.dropdown-toggle');
for (var i = 0; i < dropDownMenuLinks.length; i++) {
    dropDownMenuLinks[i].addEventListener("click", function(event) {
        console.log(this.parentElement.lastElementChild.classList.contains('d-block'))
        event.preventDefault();

        if (!this.parentNode.lastElementChild.classList.contains('d-block')) {
        }
    })
}