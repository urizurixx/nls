...
var dropDownMenu = document.querySelectorAll('ul.navbar-nav li.dropdown.nav-item');
for (var i = 0; i < dropDownMenu.length; i++) {
    dropDownMenu[i].addEventListener("mouseenter", function() {
        dropDownMenu[i].lastElementChild.classList.add('d-block')
    })
    dropDownMenu[i].addEventListener("mouseleave", function() {
        dropDownMenu[i].lastElementChild.classList.remove('d-block')
    })
}
